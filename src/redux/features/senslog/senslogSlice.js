...
import { downloadingWaterBenderAvg, downloadingWaterBenderLast, downloadingWaterBenderMonthly } from './senslogService'
...
export const senslogSlice = createSlice({
    name: 'senslog',
    initialState: {
        isLoading: false,
        isError: false,
...
export const { resetSenslog } = senslogSlice.actions
export default senslogSlice.reducer