...
import { BaseScreen, Body, BodyLarge, MyModalError } from "../../components";
...
const OtpForgetPassword = ({
    email, isError, isSuccess, isLoading, message, validateOtpLogin, onNavigation,
    onCloseModalError, forgetPasswordInfo
}) => {
        ...
        <BaseScreen barBackgroundColor={COLOR_WHITE} contentStyle={{ paddingHorizontal: 20 }}>
            <View style={{ flex: 1, justifyContent: 'space-between' }}>
                <View style={styles.topView}>
                    ...
                    <Text style={styles.secondaryTitle}>We sent the code verification to your phone number <Body bold>{forgetPasswordInfo?.TELEPON}</Body> </Text>
