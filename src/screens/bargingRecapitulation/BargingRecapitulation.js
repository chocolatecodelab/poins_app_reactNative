...
import { BaseScreen, Button, BodyLarge, Body, BodySmall, BodyExtraSmall, MyHeader, DatePicker, MyModal, H2 } from "../../components";
import { COLOR_BLACK, COLOR_DISABLED, COLOR_ERROR, COLOR_PRIMARY, COLOR_TRANSPARENT_DARK, COLOR_TRANSPARENT_DISABLED, COLOR_WHITE } from '../../tools/constant';
...
const BargingRecapitulation = ({ userId, listHistory, onAppear, isLoading, onDetailPressed }) => {
  ...
  const data = [{ value: 50, label: 'Jan' }, { value: 80, label: 'Jan' }, { value: 90, label: 'Jan' }, { value: 70, label: 'Jan' }, { value: 70, label: 'Jan' }, { value: 50 }, { value: 80 }, { value: 130 },]
  return (
    <BaseScreen
