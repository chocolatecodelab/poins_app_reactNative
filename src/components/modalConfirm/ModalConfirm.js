...
import { COLOR_DISABLED, COLOR_ERROR, COLOR_MEDIUM_BLACK, COLOR_PRIMARY, COLOR_WHITE } from '../../tools/constant';
            ...
            >
                <View style={styles.modalContainer}>
                    ...
                    <View style={{ flexDirection: 'row', marginTop: 15 }}>
                        ...
                        <Button
                            caption={'Yes'}
                            containerStyle={{ flex: 1, marginLeft: 6, backgroundColor: COLOR_PRIMARY }}
                            onPress={onSubmit}
                            loading={loading}
                            disabled={disabled}
                        />
